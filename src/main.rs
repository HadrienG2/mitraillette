...
const SOLDES : [Valeur; NUM_SOLDES] = [0, 50, 100, 150, 200, 250, 300, 400, 500, 600, 700, 800, 900, 1000, 1500, 2000, 2500, 3000];
...
struct Possibilite {
    ...
    min_esperance_relance_simple: [Cell<Flottant>; NUM_SOLDES],
}
